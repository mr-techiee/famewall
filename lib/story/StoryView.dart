...
import 'package:famewall/story/StoryVideo.dart';
import 'package:famewall/story/utils.dart';
...
class StoryItem {
  ...
  StoryItem(
      this.view, {
        required this.duration,this.uploadedTime,
        this.shown = false,
      });
  ...
  factory StoryItem.pageImage({
    ...
    return StoryItem(
      ...
      shown: shown,uploadedTime:uploadedTime,
      duration: duration ?? Duration(seconds: 3),
    );
  }
...
class StoryView extends StatefulWidget {
  ...
  StoryView({
    ...
    this.repeat = false,
    this.inline = false,
    this.onVerticalSwipeComplete,this.profileImage,this.userName
  });
                ...
                child: Column(children: [PageBar(
                 ...
                 Container(margin:EdgeInsets.only(top: 10),child: Row(children: [
                   ...
                   Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                     Container(margin: EdgeInsets.only(left: 10),child: Text(widget.userName!.trim(),textAlign: TextAlign.start,style: TextStyle(color: Colors.white ,fontSize: SizeConfig.safeBlockHorizontal! * 3.5,
                         fontFamily: "Poppins-bold"),),),
                     Container(margin: EdgeInsets.only(left: 10),child: Text(_currentStory!=null&&_currentStory!.uploadedTime!=null?_currentStory!.uploadedTime!:"",textAlign: TextAlign.start,style: TextStyle(color: Colors.white ,fontSize: 10,
                         fontFamily: "Poppins-bold"),),)
                   ],)
