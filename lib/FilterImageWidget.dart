...
import 'package:famewall/PostWithTextWidget.dart';
...
class FilterImageWidget extends StatelessWidget {
...
class FilterPhotoFilterSelector extends StatefulWidget {
  final Widget title;
  ...
  const FilterPhotoFilterSelector({
    Key? key,
    required this.title,
...
class _PhotoFilterSelectorState extends State<FilterPhotoFilterSelector> {
  String? filename;
                ...
                : IconButton(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                PostWithMessageWidget(imageFile: imageFile,isVideoUpload: false,selectedFiles: selectedFiles,)),
                      ).then((value) => {
                        if(value!=null){
