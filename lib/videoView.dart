...
class VideoView extends StatefulWidget {
  ...
  VideoView({this.url, this.play, this.id,this.isMute,this.isShowTime});

  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<VideoView> with WidgetsBindingObserver {
    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
          ...
          widget.isShowTime==null?ValueListenableBuilder(
          ...
          !controller!.value.isPlaying?Positioned.fill(child: InkWell(child: Container(child: Icon(Icons.play_arrow,color: Colors.white,size: 60,),alignment: Alignment.center,),onTap: (){
